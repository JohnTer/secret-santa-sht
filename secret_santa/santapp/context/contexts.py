...
🎁 В разделе “заполнить адрес” ты можешь ввести адрес места (не забывай про индекс), куда нужно будет отправить твой подарок. В этом же разделе можно посмотреть адрес, который ты вводил последним и в случае чего изменить его. 
